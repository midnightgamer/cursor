...
var Cursor = /*#__PURE__*/function () {
  function Cursor(el) {
    ...
    this.onMouseMoveEv = function () {
      _this.cursorCnfigs.x.previous = _this.cursorCnfigs.x.current = mouse.x;
      _this.cursorCnfigs.y.previous = _this.cursorCnfigs.y.current = mouse.y; // Set cursor opacity to 1 when hovered on the screen
  ...
  _createClass(Cursor, [{
    ...
    value: function render() {
      ...
      for (var key in this.cursorCnfigs) {
        this.cursorCnfigs[key].previous = lerp(this.cursorCnfigs[key].previous, this.cursorCnfigs[key].current, this.cursorCnfigs[key].amt);
...
},{"gsap":"node_modules/gsap/index.js"}],"script.js":[function(require,module,exports) {
"use strict";
...
},{"./Cursor":"Cursor.js","gsap":"node_modules/gsap/index.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
